...
export const getAccountById = (id) => axiosAdmin.get(`/accounts/${id}`);
...
// ================= ACCOUNT REQUESTS =================
export const getAccountRequests = () => axiosAdmin.get("/account-requests");
...
export const getLoanById = (id) => axiosAdmin.get(`/loans/${id}`);

export const approveLoan = (id) => axiosAdmin.put(`/loans/approve/${id}`);

export const rejectLoan = (id) => axiosAdmin.put(`/loans/reject/${id}`);

export const payLoanInstallment = (id) => axiosAdmin.put(`/loans/pay/${id}`);

export const checkLoanMora = () => axiosAdmin.post("/loans/check-mora");

// ================= CARDS =================
export const getCards = () => axiosAdmin.get("/cards");

export const getCardsByAccount = (id) => axiosAdmin.get(`/cards/${id}`);

export const updateCardStatus = (id, data) =>
  axiosAdmin.post(`/cards/${id}`, data);

export const activateCard = (id) => axiosAdmin.post(`/cards/${id}/activate`);

export const blockCard = (id, data) =>
  axiosAdmin.post(`/cards/${id}/block`, data);

// ================= TRANSACTIONS =================
export const getTransactions = () => axiosAdmin.get("/transactions");
